...
[TestFixture]
public class TitleCell_DefaultContent_Tests : TestsBase
{
    [Test]
    ...
    public void HavingDefaultContentSetAndMultilineObjectAsContent()
    {
        ...
        dataGrid.TitleRow.TitleCell.Content = new MultilineText("Cell Content Tests");
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.TitleRow.TitleCell.DefaultContent = "Tests";

...
internal class ListReadWithCustomParserDemo : DemoBase
{
    public override string Title => "List Read - With custom parser";
    ...
    {
        ValueList<ConsoleColor> colorsRead = new("What are your preferred colors?")
        {

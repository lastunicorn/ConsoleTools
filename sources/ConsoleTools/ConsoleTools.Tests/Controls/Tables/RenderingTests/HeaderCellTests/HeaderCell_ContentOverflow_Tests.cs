...
[TestFixture]
public class HeaderCell_ContentOverflow_Tests : TestsBase
{
    [Test]
    ...
    public void HavingContentOverflowDefault()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.Default;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowPreserveOverflow()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.PreserveOverflow;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutChar()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.CutChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutCharWithEllipsis()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.CutCharWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWord()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.CutWord;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWordWithEllipsis()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.CutWordWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWrapChar()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.WrapChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWordWrap()
    {
        ...
        dataGrid.HeaderRow[1].ContentOverflow = CellContentOverflow.WrapWord;
        dataGrid.MaxWidth = 100;
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.Title = "Header ContentOverflow Tests";

        dataGrid.DisplayBorderBetweenRows = true;

        dataGrid.Columns.Add("Column 0  Lorem ipsum consectetur adipiscing elit");
        dataGrid.Columns.Add("Column 1  Lorem ipsum consectetur adipiscing elit");
        dataGrid.Columns.Add("Column 2  Lorem ipsum consectetur adipiscing elit");

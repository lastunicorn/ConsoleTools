...
[TestFixture]
public class Column_CellPaddingRight_Tests : TestsBase
{
    [Test]
    ...
    public void HavingCellPaddingRight0()
    {
        ...
        dataGrid.Columns[1].CellPaddingRight = 0;
    ...
    public void HavingCellPaddingRight1()
    {
        ...
        dataGrid.Columns[1].CellPaddingRight = 1;
    ...
    public void HavingCellPaddingRight2()
    {
        ...
        dataGrid.Columns[1].CellPaddingRight = 2;
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.Rows[1][1].Content = "cell with longer content";

...
[TestFixture]
public class ContentRow_CellContentOverflow_Tests : TestsBase
{
    [Test]
    ...
    public void HavingContentOverflowDefault()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.Default;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowPreserveOverflow()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.PreserveOverflow;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutChar()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.CutChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutCharWithEllipsis()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.CutCharWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWord()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.CutWord;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWordWithEllipsis()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.CutWordWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWrapChar()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.WrapChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWordWrap()
    {
        ...
        dataGrid.Rows[1].CellContentOverflow = CellContentOverflow.WrapWord;
        dataGrid.MaxWidth = 100;
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.Title = "Cell ContentOverflow Tests";
        ...
        dataGrid.Rows.Add("cell 00:0", "cell 00:1", "cell 00:2");
        dataGrid.Rows.Add(
            "cell 01:0 Lorem ipsum consectetur adipiscing elit",
            "cell 01:1 Lorem ipsum consectetur adipiscing elit",
            "cell 01:2 Lorem ipsum consectetur adipiscing elit");
        dataGrid.Rows.Add("cell 02:0", "cell 02:1", "cell 02:2");

...
[TestFixture]
public class HeaderRow_CellDefaultContent_Tests : TestsBase
{
    [Test]
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.TitleRow.CellDefaultContent = "Header Content Tests";

        dataGrid.Columns.Add(new Column());
        dataGrid.Columns.Add(new Column());
        dataGrid.Columns.Add(new Column());

        dataGrid.HeaderRow.CellDefaultContent = "Column";

...
using DustInTheWind.ConsoleTools.Tests.Utils;

namespace DustInTheWind.ConsoleTools.Tests;

public class TestsBase
{
    protected string GetResourceFileContent(string resourceFileName)
    {
        Type callerType = GetCallerType();
        string fullResourceFileName = ComputeFullResourceFileName(resourceFileName, callerType);
        return TestResources.ReadTextFile(fullResourceFileName, callerType.Assembly);
    }

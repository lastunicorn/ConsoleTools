...
[TestFixture]
public class Column_CellPaddingLeft_Tests : TestsBase
{
    [Test]
    public void HavingNoCellPaddingLeftSpecified()
    {
    ...
    [Test]
    public void HavingCellPaddingLeft0()
    {
        DataGrid dataGrid = CreateDummyDataGrid();

        dataGrid.Columns[1].CellPaddingLeft = 0;
    ...
    [Test]
    public void HavingCellPaddingLeft1()
    {
        DataGrid dataGrid = CreateDummyDataGrid();

        dataGrid.Columns[1].CellPaddingLeft = 1;
    ...
    [Test]
    public void HavingCellPaddingLeft2()
    {
        DataGrid dataGrid = CreateDummyDataGrid();

        dataGrid.Columns[1].CellPaddingLeft = 2;

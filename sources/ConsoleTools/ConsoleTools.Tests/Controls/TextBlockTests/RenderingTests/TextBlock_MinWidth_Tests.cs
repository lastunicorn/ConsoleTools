...
[TestFixture]
public class TextBlock_MinWidth_Tests : TestsBase
{
    [Test]
    public void HavingLongerWidth()
    {
        ...
        string expected = GetResourceFileContent("01-minwidth-long.txt");
    ...
    public void HavingShorterWidth()
    {
        ...
        string expected = GetResourceFileContent("02-minwidth-short.txt");
        textBlock.IsEqualTo(expected);
    }
    ...
    public void HavingExactWidth()
    {
        ...
        string expected = GetResourceFileContent("03-minwidth-exact.txt");
        textBlock.IsEqualTo(expected);
    }
}
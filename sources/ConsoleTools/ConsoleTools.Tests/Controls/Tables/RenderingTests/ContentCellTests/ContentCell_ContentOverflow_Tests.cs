...
[TestFixture]
public class ContentCell_ContentOverflow_Tests : TestsBase
{
    [Test]
    ...
    public void HavingContentOverflowDefault()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.Default;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowPreserveOverflow()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.PreserveOverflow;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutChar()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.CutChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutCharWithEllipsis()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.CutCharWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWord()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.CutWord;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWordWithEllipsis()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.CutWordWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWrapChar()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.WrapChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWordWrap()
    {
        ...
        dataGrid.Rows[1][1].ContentOverflow = CellContentOverflow.WrapWord;
        dataGrid.MaxWidth = 100;

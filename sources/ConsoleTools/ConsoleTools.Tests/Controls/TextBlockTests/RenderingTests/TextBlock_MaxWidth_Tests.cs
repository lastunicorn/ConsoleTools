...
[TestFixture]
public class TextBlock_MaxWidth_Tests : TestsBase
{
    [Test]
    public void HavingLongerWidth()
    {
        ...
        string expected = GetResourceFileContent("01-maxwidth-long.txt");
    ...
    public void HavingShorterWidth()
    {
        ...
        string expected = GetResourceFileContent("02-maxwidth-short.txt");
        textBlock.IsEqualTo(expected);
    }
    ...
    public void HavingExactWidth()
    {
        ...
        string expected = GetResourceFileContent("03-maxwidth-exact.txt");
        textBlock.IsEqualTo(expected);
    }
}
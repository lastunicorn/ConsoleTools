// ConsoleTools
// Copytop (C) 2017-2024 Dust in the Wind
// 
...
[TestFixture]
public class Column_CellPaddingTop_Tests : TestsBase
{
    [Test]
    public void HavingNoCellPaddingTopSpecified()
    {
    ...
    [Test]
    public void HavingCellPaddingTop0()
    {
        DataGrid dataGrid = CreateDummyDataGrid();

        dataGrid.Columns[1].CellPaddingTop = 0;
    ...
    [Test]
    public void HavingCellPaddingTop1()
    {
        DataGrid dataGrid = CreateDummyDataGrid();

        dataGrid.Columns[1].CellPaddingTop = 1;
    ...
    [Test]
    public void HavingCellPaddingTop2()
    {
        DataGrid dataGrid = CreateDummyDataGrid();

        dataGrid.Columns[1].CellPaddingTop = 2;
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.Columns.Add("This is Column 0");
        dataGrid.Columns.Add("This is Column 1");
        dataGrid.Columns.Add("This is Column 2");

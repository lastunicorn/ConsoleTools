...
public class ContentRow_BorderVisibility_MiddleRow_Tests : TestsBase
{
    ...
    {
        dataGrid.Rows[2].BorderVisibility = new BorderVisibility(true, true, true, false);
    ...
    {
        dataGrid.Rows[2].BorderVisibility = new BorderVisibility(true, false, true, true);
    ...
    {
        dataGrid.Rows[2].BorderVisibility = new BorderVisibility(true, true, true, true);

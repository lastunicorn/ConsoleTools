...
[TestFixture]
public class ContentCell_ColumnSpan_ContentRowMiddle_Tests : TestsBase
{
    [Test]
    ...
    public void HavingColumnSpan2_WhenRendered()
    {
        ...
        List<ContentCell> row1Cells = CreateCells(3, 1);
        dataGrid.Rows.Add(row1Cells);

        List<ContentCell> row2Cells = CreateCells(4, 2);
        dataGrid.Rows.Add(row2Cells);

        row1Cells[1].ColumnSpan = 2;
    ...
    public void HavingColumnSpan3_WhenRendered()
    {
        ...
        List<ContentCell> row1Cells = CreateCells(2, 1);
        dataGrid.Rows.Add(row1Cells);

        List<ContentCell> row2Cells = CreateCells(4, 2);
        dataGrid.Rows.Add(row2Cells);

        row1Cells[1].ColumnSpan = 3;
    ...
    public void HavingColumnSpan3AndHorizontalAlignRight_WhenRendered()
    {
        ...
        row1Cells[1].ColumnSpan = 3;
        row1Cells[1].HorizontalAlignment = HorizontalAlignment.Right;

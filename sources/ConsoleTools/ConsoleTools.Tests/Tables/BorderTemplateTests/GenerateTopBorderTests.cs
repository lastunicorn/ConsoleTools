...
namespace DustInTheWind.ConsoleTools.Tests.Tables.BorderTemplateTests
{
    [TestFixture]
    public class GenerateTopBorderTests
    {
        [Test]
        ...
        public void one_column_with_length_0()
        {
            ...
            string actual = borderTemplate.GenerateTopBorder(0);
        ...
        public void one_column_with_length_5()
        {
            ...
            string actual = borderTemplate.GenerateTopBorder(5);
        ...
        public void two_columns_with_length_0_and_5()
        {
            ...
            string actual = borderTemplate.GenerateTopBorder(0, 5);
        ...
        public void two_columns_with_length_5_and_0()
        {
            ...
            string actual = borderTemplate.GenerateTopBorder(5, 0);
        ...
        public void two_columns_with_length_5_and_5_List()
        {
            ...
            string actual = borderTemplate.GenerateTopBorder(new List<int> { 5, 5 });

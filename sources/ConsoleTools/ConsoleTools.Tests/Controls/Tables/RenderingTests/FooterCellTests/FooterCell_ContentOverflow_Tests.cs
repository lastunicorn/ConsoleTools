...
namespace DustInTheWind.ConsoleTools.Tests.Controls.Tables.RenderingTests.FooterCellTests;

[TestFixture]
public class FooterCell_ContentOverflow_Tests : TestsBase
{
    [Test]
    ...
    public void HavingContentOverflowDefault()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.Default;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowPreserveOverflow()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.PreserveOverflow;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutChar()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.CutChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutCharWithEllipsis()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.CutCharWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWord()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.CutWord;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowCutWordWithEllipsis()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.CutWordWithEllipsis;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWrapChar()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.WrapChar;
        dataGrid.MaxWidth = 100;
    ...
    public void HavingContentOverflowWordWrap()
    {
        ...
        dataGrid.FooterRow.FooterCell.ContentOverflow = CellContentOverflow.WrapWord;
        dataGrid.MaxWidth = 100;
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.Title = "Footer ContentOverflow Tests";
        ...
        dataGrid.Footer = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.";

...
[TestFixture]
public class GetLines_CharCut_OneLineWithNoSpaces_Test
{
    [Test]
    public void HavingWidthGreaterThanLine_WhenLinesAreGenerated_ThenThatLineIsReturned()
    {
    ...
    [Test]
    public void HavingWidthSmallerThanLine_WhenLinesAreGenerated_ThenFirstPartOfTheLineIsReturned()
    {
        MultilineText multilineText = new("1234567890");

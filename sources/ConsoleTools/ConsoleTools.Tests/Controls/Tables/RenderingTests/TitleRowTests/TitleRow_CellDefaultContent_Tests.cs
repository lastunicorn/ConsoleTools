...
[TestFixture]
public class TitleRow_CellDefaultContent_Tests : TestsBase
{
    [Test]
    ...
    public void HavingNullContent()
    {
        ...
        dataGrid.TitleRow.TitleCell.Content = null;
    ...
    public void HavingEmptyStringContent()
    {
        ...
        dataGrid.TitleRow.TitleCell.Content = string.Empty;
    ...
    public void HavingEmptyMultilineContent()
    {
        ...
        dataGrid.TitleRow.TitleCell.Content = MultilineText.Empty;
    ...
    public void HavingMultilineObjectAsContent()
    {
        ...
        dataGrid.TitleRow.TitleCell.Content = new MultilineText("Title Content Tests");
    ...
    private static DataGrid CreateDummyDataGrid()
    {
        ...
        dataGrid.TitleRow.CellDefaultContent = "Tests";

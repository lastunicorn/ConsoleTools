...
namespace DustInTheWind.ConsoleTools.Demo.ProgressBarkDemo.BusinessLayer
{
    /// <summary>
    /// Base class that asynchronously runs some code and provides support to announce its progress.
    /// </summary>
    internal abstract class JobBase
    {
        ...
        /// <summary>
        /// Gets a value that specifies if the job is running.
        /// </summary>
        ...
        /// The <see cref="Start"/> method immediately return and the job remains to be run on a background thread.
        /// </summary>
        public void Start()
        {
            finishEvent.Reset();

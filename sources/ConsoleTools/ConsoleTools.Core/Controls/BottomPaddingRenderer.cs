...
internal class BottomPaddingRenderer : IRenderer
{
    private int lineIndex;
    private readonly ControlDisplay controlDisplay;
    private readonly ControlLayout controlLayout;

    public bool HasMoreLines => lineIndex < controlLayout.Padding.Bottom;

    public BottomPaddingRenderer(ControlDisplay controlDisplay, ControlLayout controlLayout)
    {
    ...
    {
        if (lineIndex >= controlLayout.Padding.Bottom)
            return;
